...
1. Start at [README.md](README.md) — the Raw / Wiki / Schema model and how this
   vault is organised.
2. Read [_FRONTMATTER.md](_FRONTMATTER.md) before writing a new note.
3. For domain/behaviour questions, read [ddd/README.md](ddd/README.md) (bounded
   contexts + ubiquitous language).
4. For a recurring failure or "have we hit this before?", read
