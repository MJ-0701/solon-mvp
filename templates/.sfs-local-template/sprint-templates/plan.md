...
Gate 3 은 Gate 2 의 raw 요구를 그대로 수용하는 단계가 아니라, AI 가 안전하게 실행할 수 있는 계약으로
...
- [ ] 의존성 / 결정 대기 항목이 명시됨
- [ ] Gate 2 의 핵심 질문이 해소됐거나 명시적으로 defer 됨
...
> 본 체크리스트 통과 = `/sfs review --gate 3` 진입 조건. verdict (pass / partial / fail) 는 `review.md` 에 기록.

## §5. Sprint Contract (Generator ↔ Evaluator)

`brainstorm.md` 의 Gate 2 맥락을 기반으로 이번 sprint 의 실행 계약을 명시한다.
