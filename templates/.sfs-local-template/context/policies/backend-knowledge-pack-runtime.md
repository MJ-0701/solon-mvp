---
id: sfs-policy-backend-knowledge-pack-runtime
summary: Backend architecture, deployment runtime, JVM, JPA, and HikariCP checks.
load_when:
  - backend
  - architecture
  - runtime
...
content_policy: "read after backend-knowledge-pack.md activates BE-ARCH, BE-CICD, BE-JVM, BE-JPA, or BE-HIKARI"
---
