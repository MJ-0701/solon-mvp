---
id: sfs-policy-backend-knowledge-pack-transactions
summary: Transaction, Spring Batch, event, outbox, and idempotency checks.
load_when:
  - backend
  - transaction
  - Spring Batch
...
content_policy: "read after backend-knowledge-pack.md activates BE-TX, BE-BATCH-TX, BE-EVENT, or BE-IDEMP"
---
