...
Use it to decide which Strategy/PM concepts are active for a sprint, plan,
review, or release. Record ids only unless the user asks for fill work.
...
- When the work is SFS product development, all six core divisions are eligible.
