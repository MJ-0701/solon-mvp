---
id: sfs-policy-backend-knowledge-pack-integration
summary: Partner integration, HTTP resilience, async, cache, lock, API, data, MQ, and SecOps checks.
load_when:
  - backend
  - integration
  - HTTP
...
content_policy: "read after backend-knowledge-pack.md activates integration, resilience, API, data, MQ, or SecOps ids"
---
