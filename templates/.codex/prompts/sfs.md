...
8. For implementation and review work, follow the routed context guardrails:
   ...
   mechanical implementation helpers use `gpt-5.3-codex-spark`.
   Claude/Gemini keep their configured tier families. Model routing applies by
   default, no user setup required. Helper-grade simple
