...
10. Taxonomy is a product function, not an org division or copy polish. Match
...
11. If a required command argument is missing, ask one plain-language question
