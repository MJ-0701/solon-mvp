...
11. For implementation and review work, follow the routed context guardrails:
   ...
   (Claude Opus 4.7, Codex `gpt-5.5` xhigh, Gemini high).
...
14. Taxonomy is a product function, not an org division or copy polish. Match
...
15. If a required command argument is missing, ask one plain-language question
