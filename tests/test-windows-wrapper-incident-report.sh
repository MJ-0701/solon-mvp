...
ko_report="${DIST_DIR}/docs/ko/windows-wrapper-incident-0.6.42.md"
en_report="${DIST_DIR}/docs/en/windows-wrapper-incident-0.6.42.md"
...
assert_contains "${ko_report}" "label 없는 thin PowerShell trampoline" "KO report thin cmd trampoline"
...
assert_contains "${ko_report}" "| P9 |" "KO report P9"
assert_contains "${ko_report}" "최종 기준선은 0.6.42" "KO report final baseline"
...
assert_contains "${en_report}" "label-free thin PowerShell trampoline" "EN report thin cmd trampoline"
...
assert_contains "${en_report}" "| P9 |" "EN report P9"
assert_contains "${en_report}" "The final baseline is 0.6.42" "EN report final baseline"

assert_contains "${DIST_DIR}/docs/ko/index.md" "windows-wrapper-incident-0.6.42.md" "KO index report link"
assert_contains "${DIST_DIR}/docs/en/index.md" "windows-wrapper-incident-0.6.42.md" "EN index report link"
