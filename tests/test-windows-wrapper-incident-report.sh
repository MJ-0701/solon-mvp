...
ko_report="${DIST_DIR}/docs/ko/windows-wrapper-incident-0.6.41.md"
en_report="${DIST_DIR}/docs/en/windows-wrapper-incident-0.6.41.md"
...
assert_contains "${ko_report}" "| P8 |" "KO report P8"
assert_contains "${ko_report}" "최종 기준선은 0.6.41" "KO report final baseline"
...
assert_contains "${en_report}" "| P8 |" "EN report P8"
assert_contains "${en_report}" "The final baseline is 0.6.41" "EN report final baseline"

assert_contains "${DIST_DIR}/docs/ko/index.md" "windows-wrapper-incident-0.6.41.md" "KO index report link"
assert_contains "${DIST_DIR}/docs/en/index.md" "windows-wrapper-incident-0.6.41.md" "EN index report link"
