...
ko_report="${DIST_DIR}/docs/ko/windows-wrapper-incident-0.6.49.md"
en_report="${DIST_DIR}/docs/en/windows-wrapper-incident-0.6.49.md"
...
assert_contains "${ko_report}" "최종 기준선은 0.6.49" "KO report final baseline"
...
assert_contains "${en_report}" "The final baseline is 0.6.49" "EN report final baseline"

assert_contains "${DIST_DIR}/docs/ko/index.md" "windows-wrapper-incident-0.6.49.md" "KO index report link"
assert_contains "${DIST_DIR}/docs/en/index.md" "windows-wrapper-incident-0.6.49.md" "EN index report link"
