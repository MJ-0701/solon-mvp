...
DESIGN_OPS_EN="${ROOT_DIR}/templates/.sfs-local-template/context/policies/design-knowledge-pack-operating.md"
DESIGN_OPS_KO="${ROOT_DIR}/templates/.sfs-local-template/context/policies/design-knowledge-pack-operating.ko.md"
...
assert_contains "${DESIGN_OPS_EN}" "repair-first UX contract"
assert_contains "${DESIGN_OPS_EN}" "Server-side 4xx validation is a final safety net"
assert_contains "${DESIGN_OPS_EN}" "Repair matrix for validation states"
assert_contains "${DESIGN_OPS_EN}" "Playwright or equivalent browser automation"
...
assert_contains "${DESIGN_OPS_KO}" "repair-first UX contract"
assert_contains "${DESIGN_OPS_KO}" "[Product]"
assert_contains "${DESIGN_OPS_KO}" "AI 에게 맡기기"
assert_contains "${DESIGN_OPS_KO}" "시네마틱"
assert_contains "${DESIGN_OPS_KO}" "structured information"
assert_contains "${DESIGN_OPS_KO}" "사용자 확인 전에 browser 검증"
