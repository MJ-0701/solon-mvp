...
assert_contains "${POLICIES}/ddd-tdd-knowledge-pack.md" "Development is wider than coding" "EN ddd-tdd dev loop lens"
...
assert_contains "${POLICIES}/ddd-tdd-knowledge-pack.ko.md" "개발은 코딩보다 넓다" "KO ddd-tdd dev loop lens"
...
assert_contains "${POLICIES}/qa-knowledge-pack.md" "QA-AIERA-006" "EN qa AI-code provenance id"
assert_contains "${POLICIES}/qa-knowledge-pack.md" "AI-generated-code provenance as a review-depth signal" "EN qa provenance lens"
assert_contains "${POLICIES}/qa-knowledge-pack.md" "local diff review before PR and PR-stage review before merge" "EN qa two-layer review harness"
assert_contains "${POLICIES}/qa-knowledge-pack.md" "Autofix is not auto-truth" "EN qa autofix lens"
assert_contains "${POLICIES}/qa-knowledge-pack.md" "AI-assisted QA should read both sides of a boundary" "EN qa pair-read lens"
...
assert_contains "${POLICIES}/qa-knowledge-pack.ko.md" "QA-AIERA-006" "KO qa AI-code provenance id"
assert_contains "${POLICIES}/qa-knowledge-pack.ko.md" "AI-generated-code provenance 자체를 review-depth 신호" "KO qa provenance lens"
assert_contains "${POLICIES}/qa-knowledge-pack.ko.md" "Autofix 는 auto-truth 가 아니다" "KO qa autofix lens"
assert_contains "${POLICIES}/qa-knowledge-pack.ko.md" "경계면 양쪽을 동시에 읽어야" "KO qa pair-read lens"
