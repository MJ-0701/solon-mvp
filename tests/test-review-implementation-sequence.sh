...
assert_file_contains "${review_context}" "AC/ADR subset ownership" "review context parallel AC/ADR subset"
assert_file_contains "${review_context}" "expected tests/" "review context parallel expected tests"
assert_file_contains "${review_context}" "output report path" "review context parallel report path"
assert_file_contains "${review_context}" "merge/conflict policy" "review context parallel merge policy"
...
assert_file_contains "${review_script}" "Implementation Acceptance Ledger" "review prompt implementation acceptance ledger"
assert_file_contains "${review_script}" "implemented/missing/deferred/waived" "review prompt ledger statuses"
assert_file_contains "${review_script}" 'agent_mode: parallel' "review prompt parallel mode"
assert_file_contains "${review_script}" "AC/ADR subset ownership" "review prompt parallel AC/ADR subset"
assert_file_contains "${review_script}" "expected tests/evidence" "review prompt parallel expected evidence"
assert_file_contains "${review_script}" "output report path" "review prompt parallel report path"
assert_file_contains "${review_script}" "merge/conflict policy" "review prompt parallel merge policy"
assert_file_contains "${review_script}" "Wiki QA/QC ledger" "review prompt wiki QA/QC ledger"
assert_file_contains "${review_script}" "project-applied QA/QC result" "review prompt project-applied result"
assert_file_contains "${review_script}" "production/applied status" "review prompt production-applied result"
