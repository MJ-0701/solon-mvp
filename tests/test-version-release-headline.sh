...
[[ "${plain_output}" == "sfs 0.8.61" ]] || fail "plain version output changed: ${plain_output}"
assert_contains_text "${output}" "sfs 0.8.61" "version output"
assert_contains_text "${output}" "latest 0.8.61" "latest output"
...
assert_contains_text "${output}" "AI Readiness" "0.8.61 headline opening clause"
...
assert_contains_text "${fallback_output}" "AI-readiness 진단" "0.8.61 release-notes distinctive clause"
