...
assert_contains "${kernel}" "Do not ask the user to request the next review" "kernel no user-triggered rerun"
...
assert_contains "${review}" "complete the rework loop in the same cycle" "review same-cycle micro rework"
