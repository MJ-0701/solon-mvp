...
assert_contains "${DESIGN_EN}" "AI-slop signals" "EN AI slop"
assert_contains "${DESIGN_EN}" "Wanted Montage-style" "EN starter set"
assert_contains "${DESIGN_EN}" "Coolicons" "EN icon starter"
assert_contains "${DESIGN_EN}" "Pretendard" "EN font starter"
assert_contains "${DESIGN_EN}" "letter-spacing at 0" "EN Korean typography"
...
assert_contains "${DESIGN_KO}" "AI-slop signal" "KO AI slop"
assert_contains "${DESIGN_KO}" "원티드 몽타주" "KO starter component"
assert_contains "${DESIGN_KO}" "Coolicons" "KO icon starter"
assert_contains "${DESIGN_KO}" "Pretendard" "KO font starter"
assert_contains "${DESIGN_KO}" "letter-spacing 은 기본 0" "KO typography"
