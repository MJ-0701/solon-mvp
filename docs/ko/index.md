---
doc_id: sfs-docs-index-ko
title: "Solon Product 문서"
...
Obsidian 은 권장 프로젝트 기억 layer 로 쓸 수 있습니다. 신규 SFS 프로젝트는 scaffold 이후 repo root
vault 와 `llm-wiki/` map 을 만들 수 있고, 기존 프로젝트는 `sfs adopt` 이후 문서를 by-reference 로
