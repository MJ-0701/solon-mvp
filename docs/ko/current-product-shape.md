...
macOS/Linux 처럼 `sfs` 를 씁니다. 0.6.64 기준 Scoop manifest 는 generated shim 이
...
0.6.64 기준 backend, 전략/PM, QA, 디자인/frontend, infra/DevOps, 경영관리, taxonomy 지식팩은
...
0.6.64 에서는 agent-skills 벤치마크에서 유용한 discipline 도 같은 방식으로 흡수했습니다.
