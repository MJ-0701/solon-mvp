...
| [Windows SFS wrapper incident report](./windows-wrapper-incident-0.6.54.md) | To understand the Windows `sfs.cmd` usage-only / empty-output / UTF-8 / upgrade fix |
...
As of 0.6.54, backend, strategy/PM, QA, design/frontend, infra/DevOps,
