...
> **As of 0.6.72**, one `brew install` / `scoop install` lets Claude Code
...
Old projects can be upgraded into the lighter 0.6.72 shape. Use
...
0.6.72 also includes the filled division knowledge packs. The user does not need to choose
...
As of 0.6.72, agent-skills-style practices are absorbed into existing SFS
