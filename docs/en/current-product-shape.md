...
keep using `sfs`, like macOS/Linux. As of 0.6.71, the Scoop manifest keeps the
...
As of 0.6.71, the backend, strategy/PM, QA, design/frontend, infra/DevOps,
...
As of 0.6.71, useful disciplines from the agent-skills benchmark are absorbed
