...
keep using `sfs`, like macOS/Linux. As of 0.6.72, the Scoop manifest keeps the
...
As of 0.6.72, the backend, strategy/PM, QA, design/frontend, infra/DevOps,
...
As of 0.6.72, useful disciplines from the agent-skills benchmark are absorbed
