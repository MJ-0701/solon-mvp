...
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 P18 로 이
...
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 P1-P17
...
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 P1-P16
...
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 P1-P15
...
- Windows guardrail 과 release verifier 는 이제 packaged `sfs.ps1` 안의 `ValueFromRemainingArguments` 를
  회귀로 보고 실패시킵니다.
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 P1-P14
...
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 P1-P13
...
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 P1-P12
...
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 이후 P1-P12
  문제 목록과 `스프린트 생성 테스트` Windows smoke 기준으로 최신화했습니다.
...
- 현재 0.6.51 기준으로는 0.6.49 이하의 깨진 wrapper 때문에 `sfs.cmd update` 도 usage 만 출력하는
  경우 최초 1회 `scoop update` 후 `scoop update sfs`, 그리고 `sfs.cmd upgrade --no-self-upgrade` 로 복구합니다.
- [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 는 이후
...
- 이번 Windows wrapper 장애 흐름과 발견된 문제점은
  [Windows SFS 래퍼 장애 요약 보고서](./docs/ko/windows-wrapper-incident-0.6.51.md) 에 정리했습니다.
