...
version: live
last_overwrite: 2026-05-02T01:14:00Z
session: "user-active: WU-38 closed + 0.5.61-product deployed"
...
resume_hint:
  default_action: |
    ...
    3) Do not auto-resume WU-38; it is closed and 0.5.61-product is deployed.
  ...
  on_ambiguous: "WU-38 is closed/deployed. Pick next WU/domain, or wait?"
  safety_locks:
...
- WU-38 closed and released as `0.5.61-product`. The Homebrew stale-tap gap is fixed in `sfs upgrade`, and `verify-product-release.sh --version 0.5.61-product` passed across product tag, Homebrew formula/tap/installed runtime, and Scoop manifest/hash.
