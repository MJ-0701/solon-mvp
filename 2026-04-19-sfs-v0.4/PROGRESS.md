...
version: live
last_overwrite: 2026-05-02T02:40:00Z
session: "idle: WU-44 released"
...
resume_hint:
  default_action: |
    ...
    3) WU-44 is closed and released as `0.5.67-product`; ask user for the next
  ...
  on_ambiguous: "WU-44 is released. What should Solon handle next?"
  safety_locks:
