...
resume_hint:
  ...
  version: 10   # v1 (14th) → v7 (20th) → v8 (22nd) → v9 (23rd 초반: WU-31 신설 + release tooling β + spec-only) → v10 (23rd 후반: FUSE 사고 P-08 후보 + sandbox file:// clone α 변형 채택 + §1.5' commit-manual 격상 + ε VM 장기 + 24th resume signal "이전 세션 이어서 ㄱㄱ" 자동 진행 path)
---
