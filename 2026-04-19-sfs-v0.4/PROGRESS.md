...
version: live
last_overwrite: 2026-05-02T01:33:08Z
session: "idle: WU-39 closed"
...
resume_hint:
  default_action: |
    ...
    3) WU-39 is closed and released as 0.5.62-product. Ask user for the next
       WU/domain.
  on_skip_patterns: ["아니", "잠깐", "다른", "stop"]
  on_skip_action: "What do you want to do instead (1 line)?"
  on_ambiguous: "WU-39 is closed. What should we work on next?"
  safety_locks:
