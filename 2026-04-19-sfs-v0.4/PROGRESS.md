...
version: live
last_overwrite: 2026-05-02T01:14:30Z
session: "user-active: WU-39 context-routing structure"

# ── ENTRY POINTERS (2-file entry) ────────────────────────────────
current_wu: WU-39
current_wu_path: 2026-04-19-sfs-v0.4/sprints/WU-39.md
...
current_wu_owner: codex-context-routing-20260502
...
resume_hint:
  default_action: |
    ...
    3) Continue WU-39 context-routing structure if it is still open. Otherwise
       ask user for the next WU/domain.
  on_skip_patterns: ["아니", "잠깐", "다른", "stop"]
  on_skip_action: "What do you want to do instead (1 line)?"
  on_ambiguous: "WU-39 may be in progress. Continue context-routing structure?"
  safety_locks:
...
- WU-38 closed and released as `0.5.61-product`. WU-39 opened to convert Solon adapters into short routers plus command/policy context modules.

## ② In-Progress

- WU-39 context-routing structure: implemented and smoke-tested. Next is commit, release as `0.5.62-product`, and close.

## ③ Next

- Commit WU-39 implementation, cut `0.5.62-product`, update Homebrew/Scoop, verify installed runtime.
