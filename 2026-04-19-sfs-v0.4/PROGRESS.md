...
version: live
last_overwrite: 2026-05-02T22:05:00+09:00
session: "codex: 0.5.82 product docs current flow released"
...
resume_hint:
  default_action: |
    ...
    3) Latest product release is `0.5.82-product`; ask user for the next
  ...
  on_ambiguous: "0.5.82-product is released. What should Solon handle next?"
  safety_locks:
    - "self-validation-forbidden: A/B/C 의미 결정은 사용자에게만"
    - "no destructive git"
  last_written: 2026-05-02T13:05:00Z
---
...
- Current truth is `0.5.82-product`; no active WU. Ask user for the next
