...
updated: 2026-05-02   # WU-34 완료: Codex CLI SFS invocation policy. Codex CLI 공식 entry = `$sfs ...`, Windows PowerShell direct shell = `sfs.cmd ...`, Codex app `/sfs ...` 는 host 가 모델까지 전달하는 surface 에서만 first-class.
---
