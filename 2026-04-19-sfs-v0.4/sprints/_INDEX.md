...
updated: 2026-05-02   # WU-47 완료: Context router same-version repair audit.
---
...
| WU-47 | Context router same-version repair audit — user-side fresh init is routed correctly; same-version upgrade now restores `_INDEX.md` and `kernel.md`; dev repo SFS Skill now self-dogfoods the 36-line router plus `.sfs-local/context/`. | `3f11052` | 2026-05-02 | 2026-05-02 | codex-sfs-context-router-audit | [WU-47.md](WU-47.md) |
