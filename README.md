...
> **0.6.0부터**: `brew install` / `scoop install` 한 번으로 Claude Code (`/sfs`),
...
| Release notes | [RELEASE-NOTES.md](./RELEASE-NOTES.md) | planned |
| Detailed changelog | [CHANGELOG.md](./CHANGELOG.md) | [CHANGELOG.md](./CHANGELOG.md) |
...
0.6.0부터는 기본 설치가 더 가볍습니다. Solon 본체는 패키지 쪽에 두고, 프로젝트에는
