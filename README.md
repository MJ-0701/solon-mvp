...
> **0.6.47 기준**: `brew install` / `scoop install` 한 번으로 Claude Code (`/sfs`),
...
0.6.47 기준으로는 backend, 전략/PM, QA, 디자인, 운영, 경영관리, taxonomy 같은 분야별 지식팩도
...
0.6.47 기준 기본 설치는 가볍습니다. Solon 본체는 패키지 쪽에 두고, 프로젝트에는
